...
import { faBars, faSignOutAlt, faSearch, faPlusCircle, faUser, faSpinner } from '@fortawesome/free-solid-svg-icons';
...
library.add(faBars, faSignOutAlt, faSearch, faPlusCircle, faUser, faSpinner);
